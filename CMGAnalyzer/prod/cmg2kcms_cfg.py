...
process.MuMuJPsiMuMu.genParticlesLabel = cms.InputTag('genParticlesPruned')
...
process.MuMuJPsiElEl.genParticlesLabel = cms.InputTag('genParticlesPruned')
...
process.MuElJPsiMuMu.genParticlesLabel = cms.InputTag('genParticlesPruned')
...
process.MuElJPsiElEl.genParticlesLabel = cms.InputTag('genParticlesPruned')
...
process.ElElJPsiMuMu.genParticlesLabel = cms.InputTag('genParticlesPruned')
...
process.ElElJPsiElEl.genParticlesLabel = cms.InputTag('genParticlesPruned')
