...
void ana(string decayMode = "ElEl2Mu", string imageOutDir = "", TString weight = "", TCut cut = "")
{
  ...
  const std::string mcPath = "/afs/cern.ch/work/g/geonmo/private/CMSSW_5_3_14_patch2/src/KoPFA/TopJpsi/result/"; //Out_Lsigma_rereco"; //Out_2pfmuptFrac"; //Out_2pfmu"; //Out_1softmulxy";
  const std::string rdPath = mcPath.c_str();//"/afs/cern.ch/work/j/jkim/537_V00-00-09/CMGTools/CMSSW_5_3_7_patch4/src/KoPFA/CMGAnalyzer/prod/Out_2el_rereco"; //Out_2pfmuptFrac";//Out_2pfmu"; //Out_1softmulxy";
